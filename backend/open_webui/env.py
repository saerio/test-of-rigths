...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "saensamecraftui")
if WEBUI_NAME != "saensamecraftui":
    WEBUI_NAME += " (saensamecraftui)"

WEBUI_FAVICON_URL = "https://saensamecraftui.com/favicon.png"
...
if FROM_INIT_PY:
    PACKAGE_DATA = {"version": importlib.metadata.version("saensamecraftui")}
else:
    try:
...
REDIS_KEY_PREFIX = os.environ.get("REDIS_KEY_PREFIX", "saensamecraftui")
...
OTEL_SERVICE_NAME = os.environ.get("OTEL_SERVICE_NAME", "saensamecraftui")
