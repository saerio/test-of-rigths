    ...
    try:
        if request.app.state.config.IMAGE_GENERATION_ENGINE == "openai":
            ...
            if ENABLE_FORWARD_USER_INFO_HEADERS:
                headers["X-saensamecraftui-User-Name"] = quote(user.name, safe=" ")
                headers["X-saensamecraftui-User-Id"] = user.id
                headers["X-saensamecraftui-User-Email"] = user.email
                headers["X-saensamecraftui-User-Role"] = user.role
